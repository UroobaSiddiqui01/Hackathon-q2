    ...
    <div className="bg-white min-h-screen font-sans p-16">
      ...
      <header className="border-b">
        ...
        <div className="flex justify-between items-center px-8 py-2">
          ...
          <a href="greatComp/first" className="text-gray-500">
              <FiShoppingCart size={20} />
              <span className="sr-only">Cart</span>
            </a>
            <a href="Frenchicelist" className="text-gray-500">
        ...
        <nav className="flex justify-center gap-8 text-sm font-medium border-t pt-2">
          <a href="/compo/first" className="hover:text-black text-gray-500 ">
            Feed
          </a>
          <a href="/compo/second" className="hover:text-black text-gray-500">
            In Stock
          </a>
